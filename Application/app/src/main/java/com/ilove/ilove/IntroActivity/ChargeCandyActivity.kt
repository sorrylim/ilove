...
class ChargeCandyActivity : PSAppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        var candyCount : ArrayList<UserItem.Candy> = arrayListOf(
            UserItem.Candy("400", "추후결정"),
            UserItem.Candy("200", "추후결정"), UserItem.Candy("100", "추후결정"),
            UserItem.Candy("50", "추후결정"), UserItem.Candy("40", "추후결정"),
            UserItem.Candy("20", "추후결정"), UserItem.Candy("10", "추후결정"))
